...
![CelebA Samples]({{ "/assets/images/celeba-samples.png" | relative_url }})
...
Latent dim 100, hidden channels $[128, 256, 512, 1024]$ for VAE (2048 hidden dims), $[128, 256, 512]$ for autoencoder (1024 hidden dims).
...
![Autoencoder Latent Space]({{ "/assets/images/autoencoder-latent.png" | relative_url }})

Here's what the autoencoder baseline looks like after 30 epochs - it reconstructs well but the latent space visualization shows repeated patterns. Without the KL term, there's no pressure to organize the latent space nicely. This grid is generated by sweeping across two dimensions of the 100D latent space.

![VAE Latent Space]({{ "/assets/images/vae-latent.png" | relative_url }})
...
![Latent Space Interpolation]({{ "/assets/images/vae-interpolation.png" | relative_url }})
...
![Random Samples from Prior]({{ "/assets/images/vae-random-samples.png" | relative_url }})
...
![PCA Latent Space Grid]({{ "/assets/images/pca-grid.png" | relative_url }})
...
![GAN Latent Space Interpolation]({{ "/assets/images/gan-interpolation.png" | relative_url }})
...
![GAN Generated Faces]({{ "/assets/images/gan-samples.png" | relative_url }})
